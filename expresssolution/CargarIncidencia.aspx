        ...
        <ContentTemplate>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <%-- EN ESTE APARTADO SE CARGAN EN DIVERSAS TEXTBOX LOS COMENTARIOS CARGADOS DE UNA INCIDENCIA, SI ES QUE TIENE --%>
                    <%if ((string)Session["PaginaAnterior"] == "Cargar Incidencia" && !IsPostBack)
                      {
                            if (Negocio.ComentarioNegocio.ContarComentarios((int)Session["IdAModificar"]) != 0)
                            {%>
                                
                                    <div class="col">
                                        <asp:Label Text="Comentarios: " runat="server" CssClass="form-label" />
                                    <%foreach (Dominio.Comentario aux in Negocio.ComentarioNegocio.ListarComentarios((int)Session["IdAModificar"]))
                                      {
                                        txtComentarioCargado.Text = aux.Comentarios;
                                        txtComentarioCargado.Enabled = false;
                                      %>

                                        <asp:TextBox runat="server" ID="txtComentarioCargado" CssClass="form-control" AutoPostBack="true" />
                    ...
                    <%if (!(Seguridad.seguridad.EsCliente(Session["usuario"])))
                      {%>
                        ...
                        <div class="col">
                            <asp:Label Text="Comentario Final: " runat="server" CssClass="form-label" />
